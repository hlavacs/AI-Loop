...
including `__init__.py`, and 65 Python test modules under `tests/`, counting 59 top-level `test_*.py` modules plus the 6 `*_acceptance.py` programs. Supporting test utilities and the sample project are excluded.
