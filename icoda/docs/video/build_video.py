#!/usr/bin/env python3
"""Assemble and validate the deterministic ICODA introduction video.
...
OUTPUT = VIDEO_DIR / "icoda-introduction.mp4"
...
def main() -> None:
    """Build the 27-segment video and validate the finished export."""
    durations, total = read_durations()
    slides, audio = find_inputs()

    with tempfile.TemporaryDirectory(prefix="icoda-video-") as temporary:
